...
export const GAMEPLAY_CONFIG = {
    ...
    GAME_BOUND_BUFFER: 40, // buffer between canvas edge and playable area
    ...
    SUPER_MINIONS: {
        ...
        HEALTH_MULTIPLIER: 2, // health when super minions triggered
        DAMAGE_MULTIPLIER: 2, // damage when super minions triggered
        XP_MULTIPLIER: 4, // XP when super minions are killed
    },

    CRADLE_POSITIONS: {
        BLUE: { x: 200, y: 1200 }, // bottom left
        RED: { x: 1200, y: 200 },  // top right
    },
    TURRET_POSITIONS: {
        BLUE: [
            { x: 500, y: 900 },
    ...
    COMBAT: {
        ...
        HERO: {
            ...
            SIZE: 30, // visual & collision radius
        ...
        ABILITIES: {
            ...
            'hookshot': {
                COOLDOWN_MS: 5000,
                STRENGTH_RATIO: 1.0, // damage = abilityPower * ratio (was 10 damage with 10 AP)
                SPEED: 500, // pixels per second (base speed)
                RANGE: 250, // base range
            ...
            'thorndive': {
                ...
                DASH_SPEED: 800, // Dash movement speed (pixels per second)
                RANGE: 200, // Base dash range
                STRENGTH_RATIO: 1.5, // damage = abilityPower * ratio (was 15 damage with 10 AP)
                LANDING_RADIUS: 100, // AOE radius for landing damage (now equal to TAUNT_RADIUS)
                TAUNT_RADIUS: 100, // AOE radius for taunt effect (now equal to LANDING_RADIUS)
    ...
    EXPERIENCE: {
        ...
        TOWER_DESTROYED: 100,
        UNIT_KILL_RADIUS: 350, // radius within which heroes must be to get unit kill XP
    ...
    MINION_SPAWNING: {
        ...
        SPAWN_RADIUS: 100, // radius around cradle to spawn minions
    ...
    AI_BEHAVIOR: {
        TURRET_DETECTION_RANGE: 300, // Range for detecting enemy turrets
        RANDOM_OFFSETS: 120, // Random offset range for positioning
        DEFENSIVE_RANGE_BUFFER: 160, // Buffer for defensive positioning
    ...
    NEUTRAL_OBJECTIVES: {
        SPAWN_INTERVAL_MS: 30_000, // 2 minutes between spawns; first spawn at 2:00
